...
protected:
	...
	public:
		...
		bool ParseNew(constCharPtrRef<CharType> ptr_string, constCharPtrRef<CharType> ptr_string_end
									, TContext &&context
									, auto &attribute)
									//, std::type_identity<traits::scanners::attribute<TScanner, CharType, std::remove_cvref_t<TContext>::type>& attribute)
		{
...
public:
	...
	bool ParseNew(constCharPtrRef<CharType> ptr_string
							...
							, TContext &&context
							, traits::scanners::attribute<TScanner, CharType, std::remove_cvref_t<TContext>>::type& attribute)
	{
		context.UseSkipper(ptr_string, ptr_string_end);
